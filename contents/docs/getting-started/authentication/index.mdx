...
<Note type="danger" title="Danger">
  Этот раздел служит примером авторизации запросов в боте вашей команды. Его использование не обязательно — он представлен исключительно в ознакомительных целях.
</Note>
